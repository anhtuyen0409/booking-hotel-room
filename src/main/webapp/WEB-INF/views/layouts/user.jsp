...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="header-configure-area">
			<div class="language-option">
				<img src="<c:url value="/assets/user/img/flag.jpg"/>" alt=""> <span>EN <i
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="tn-right">
							...
							<a href="#" class="bk-btn">Booking Now</a>
							<div class="language-option"> <!-- <c:url value="/assets/user/img/flag.jpg"/> img/flag.jpg-->
								<img src="<c:url value="/assets/user/img/flag.jpg"/>" alt=""> <span>EN <i
									class="fa fa-angle-down"></i></span>
								<div class="flag-dropdown">
									<ul>
		...
		<div class="menu-item">
			<div class="container">
				<div class="row">
					<div class="col-lg-2">
						<div class="logo">
							<a href="./index.html"> <img src="<c:url value="/assets/user/img/logo.png"/>" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-10">
	...
	<section class="hero-section">
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="<c:url value="/assets/user/img/hero/hero-1.jpg"/>"></div>
			<div class="hs-item set-bg" data-setbg="<c:url value="/assets/user/img/hero/hero-2.jpg"/>"></div>
			<div class="hs-item set-bg" data-setbg="<c:url value="/assets/user/img/hero/hero-3.jpg"/>"></div>
		</div>
	</section>
	<!-- Hero Section End -->
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="about-pic">
						<div class="row">
							<div class="col-sm-6">
								<img src="<c:url value="/assets/user/img/about/about-1.jpg"/>" alt="">
							</div>
							<div class="col-sm-6">
								<img src="<c:url value="/assets/user/img/about/about-2.jpg"/>" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="hp-room-items">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value="/assets/user/img/room/room-b1.jpg"/>">
							<div class="hr-text">
								<h3>Double Room</h3>
								<h2>
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value="/assets/user/img/room/room-b2.jpg"/>">
							<div class="hr-text">
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value="/assets/user/img/room/room-b3.jpg"/>">
							<div class="hr-text">
								<h3>Deluxe Room</h3>
								<h2>
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value="/assets/user/img/room/room-b4.jpg"/>">
							<div class="hr-text">
								<h3>Family Room</h3>
								<h2>
				...
				<div class="col-lg-8 offset-lg-2">
					<div class="testimonial-slider owl-carousel">
						<div class="ts-item">
							...
							<img src="<c:url value="/assets/user/img/testimonial-logo.png"/>" alt="">
						</div>
						<div class="ts-item">
							<p>After a construction project took longer than expected, my
								husband, my daughter and I needed a place to stay for a few
	...
	<section class="blog-section spad">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value="/assets/user/img/blog/blog-1.jpg"/>">
						<div class="bi-text">
				...
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value="/assets/user/img/blog/blog-2.jpg"/>">
						<div class="bi-text">
				...
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value="/assets/user/img/blog/blog-3.jpg"/>">
						<div class="bi-text">
				...
				<!-- <c:url value="/assets/user/img/blog/blog-1.jpg"/> img/blog/blog-10.jpg-->
				<div class="col-lg-8">
			...
			<div class="footer-text">
				<div class="row">
					<div class="col-lg-4">
						<div class="ft-about">
							<div class="logo">
								<a href="#"> <img src="<c:url value="/assets/user/img/footer-logo.png"/>" alt="">
								</a>
							</div>
							<p>
